...
Bullet::Bullet(GameObject* associated,  float  angle , float  speed, int damage,float maxDistance,    std::string      sprite,int frames,bool targetsPlayer) {
	// TODO Auto-generated constructor stub
	...
	this->speed=speed;
	this->angle=angle;
	Component* image= new Sprite(sprite,Game::GetInstance()->GetRenderer(),this->associated,Game::GetInstance()->recursos,frames,100);
	this->associated->box.h=image->GetHeight();
	this->associated->box.w=image->GetWidth();
